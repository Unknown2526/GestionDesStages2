 ...
 * @method \App\Model\Entity\Administrateur|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Administrateur|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
